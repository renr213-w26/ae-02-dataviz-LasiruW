...
There are 1,615 movies in the dataset.
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013))+
  ...
  labs(
    x = "Budget($)", 
    y = "Gross Revenue($)", 
    title = "Bechdel Test: Impact of Movie Budget on Gross Revenue"
  )
```
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, colour = binary)) +
  ...
  labs(
    ...
    title = "Gross revenue vs. budget, by Bechdel Test Results"
  )
```
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, colour = binary, size = roi, alpha = 0.5)) +
  geom_point() + facet_wrap(~clean_test) +
  labs(
    x = "Budget (in 2013 $)", 
    y = "Gross revenue (in 2013 $)", 
    title = "Gross revenue vs. budget, by Bechdel Test Results"
...
This was not useful, it is difficult to discern between 'clean_test' and 'binary'.
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, colour = clean_test, size = roi, alpha = 0.5)) +
  geom_point() + 
  facet_wrap(~clean_test) +
  facet_grid(~binary) +
  labs(
    x = "Budget (Million $)", 
    y = "Gross revenue (Million 2013 $)", 
    title = "Gross revenue vs. budget, by Bechdel Test 2013 Results",
    size = "ROI",
    alpha = "",
    colour = "Bechdel Test Results"
    ) + 
  scale_x_continuous(label = label_number(scale = 1/1000000)) +
  scale_y_continuous(label = label_number(scale = 1/1000000))

# Changed point colors to "clean_test" to improve comparison 
# Changed Legend titles
```
...
ggplot(bechdel, aes(x = roi, y = clean_test, color = binary)) + 
  geom_boxplot() + 
  labs(x = "Bechdel Result",
       y = "Return on Investment", 
       color = "Bechdel Results"
       ) +
